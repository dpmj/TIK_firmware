...
#define PIN_EMITTER 36
#define PIN_RECEIVER 39

// #define EMITTER_ADC_UNIT ADC_UNIT_1
// #define EMITTER_ADC_CHANNEL ADC1_CHANNEL_0

// #define RECEIVER_ADC_UNIT ADC_UNIT_1
// #define RECEIVER_ADC_CHANNEL ADC1_CHANNEL_3
